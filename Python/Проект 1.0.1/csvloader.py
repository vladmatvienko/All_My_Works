...
class CSVLoader:
    ...
    def update_column_names(self, new_columns):
        """Обновляет список названий колонок после преобразований, таких как One-Hot Encoding."""
        self._column_names = new_columns
    ...
    def get_column_names(self):
        return list(self.active_data.columns)
