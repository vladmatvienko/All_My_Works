...
|  |  |
| ------ | ------ |
| ![D09_02](misc/images/D09_02.png) | Все понятно: фронтенды и бэкенды взаимодействуют через специальный слой REST API, в котором реализована вся бизнес-логика. Это действительно идеальный мир приложений. | 
